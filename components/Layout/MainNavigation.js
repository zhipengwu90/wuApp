...
function MainNavigation() {
  ...
  const navHamburger = !isToggle ? (
    ...
    <svg className={classes.closeSVG} viewBox="0 0 20 20" >
        ...
        <ul>
          <li>
            <Link
              href="/"
              onClick={toggleClose}
              className={router.asPath === "/" ? classes.active : null}
            >
              HOME
            </Link>
          </li>
          ...
          {/* <li>
            <Link
              href="/snippets"
              onClick={toggleClose}
              className={router.asPath === "/snippets" ? classes.active : null}
            >
              SNIPPETS
            </Link>
          </li> */}
          <li>
            <Link
              href="/about"
              onClick={toggleClose}
              className={router.asPath === "/about" ? classes.active : null}
            >
              ABOUT
            </Link>
          </li>
